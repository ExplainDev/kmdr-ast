...
export interface FlatAST extends Array<OptionNode | ProgramNode | AssignmentNode | OperatorNode | PipeNode | RedirectNode | ArgumentNode | OptionWithArgNode | ReservedWordNode> {
}
export interface CommandLeafNodes extends Array<ProgramNode | SubcommandNode | AssignmentNode | OptionNode | ArgumentNode> {
}
export interface ListLeafNodes extends Array<ProgramNode | AssignmentNode | OptionNode | ArgumentNode | OperatorNode> {
}
export interface ASTInstance {
    assignmentHasValue(node: AssignmentNode, name: string, value: string): boolean;
    te(): void;
